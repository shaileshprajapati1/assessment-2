...
<head>
    ...
    <!-- Custom Theme files -->
    <link href="<?php echo $this->baseURL ;?>css/bootstrap.min.css" type="text/css" rel="stylesheet" media="all">
    <link href="<?php echo $this->baseURL ;?>css/style.css" type="text/css" rel="stylesheet" media="all">
    <!-- font-awesome icons -->
        ...
        <header>
            <div class="container">
                <nav class="navbar navbar-expand-lg navbar-light p-0">
                    <h1><a class="navbar-brand" href="home">Recruit

                        </a></h1>
                    <!-- <button class="navbar-toggler ml-lg-auto ml-sm-5 bg-light" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <ul class="ml-lg-5 navbar-nav mr-lg-auto">
                            ...
                            <!-- <li class="nav-item dropdown mr-lg-4 my-lg-0 my-sm-4 my-3">
                                ...
                                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                    ...
                                    <a href="job_single">Job Single</a>
                                </div>
                            </li> -->
