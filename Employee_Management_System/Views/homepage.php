<div class="slider">
                    ...
                    <div class="d-flex banner-w3pvt-bg1 common-bg">
                        <div class="d-flex mx-auto align-items-center justify-content-center flex-column">
                            ...
                            <!-- <div class="row justify-content-between bnr-form-w3ls">
                                ...
                                <div class="col-lg-8">
                                    <form action="#" method="post" class="bnr-field">
                                        <div class="row">
        ...
        <div class="container  py-sm-5">
            ...
            <div class="row head-row-home">
                <div class="col-md-4 my-4 home-grid">
                    ...
                    <a href="about" class="btn wthree-bnr-btn">Read more</a>
                </div>
                <div class="col-md-4 my-4 home-grid">
                    <span class="head-line"></span>
    ...
    <section class="bg-theme position-relative" id="services">
        ...
        <img src="<?php echo $this->baseURL ;?>images/services.jpg" alt="" class="img-fluid">
    </section>
    <!-- //services -->
    <!-- job roles -->
                    ...
                    <div class="card border-0">
                        <div class="card-header p-0">
                            <a href="#exampleModal2" data-toggle="modal" aria-pressed="false" data-target="#exampleModal2"
                                role="button">
                                <img class="card-img-bottom" src="<?php echo $this->baseURL ;?>images/b1.jpg" alt="Card image cap">
                            </a>
                        </div>
                    ...
                    <div class="card border-0">
                        <div class="card-header p-0">
                            <a href="#exampleModal3" data-toggle="modal" aria-pressed="false" data-target="#exampleModal3"
                                role="button">
                                <img class="card-img-bottom" src="<?php echo $this->baseURL ;?>images/b2.jpg" alt="Card image cap">
                            </a>
                        </div>
                    ...
                    <div class="card border-0">
                        <div class="card-header p-0">
                            <a href="#exampleModal4" data-toggle="modal" aria-pressed="false" data-target="#exampleModal4"
                                role="button">
                                <img class="card-img-bottom" src="<?php echo $this->baseURL ;?>images/b3.jpg" alt="Card image cap">
                            </a>
                        </div>
                        <div class="card-body border-0">
                            <div class="blog_w3icon d-flex justify-content-between">
